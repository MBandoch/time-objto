    ...
    return (
      <TweakRow label={label}>
        <select className="twk-field" value={value} onChange={(e) => onChange(e.target.value)}
          style={{ appearance: 'none', boxSizing: 'border-box', width: '100%', height: 26, padding: '0 8px', border: '.5px solid rgba(0,0,0,.1)', borderRadius: 7, background: 'rgba(255,255,255,.6)', color: 'inherit', font: 'inherit', outline: 'none' }}>
          {options.map((o) => {
